...
def installPackages():
    ...
    if system() == 'Darwin':  # MACOS
        ...
        try:
            ...
            try:
                code_path = os.sep.join(os.path.dirname(os.path.abspath(__file__)).split(os.sep))
                # print(code_path)
                pip_install(os.path.join(code_path,'AREG_IOS_utils','pytorch3d-0.7.0-cp39-cp39-linux_x86_64.whl')) # py39_cu113_pyt1120
            except:
...
from AREG_IOS_utils import DatasetPatch, PredPatch, vtkMeshTeeth, vtkICP,ICP, WriteSurf, TransformSurf
